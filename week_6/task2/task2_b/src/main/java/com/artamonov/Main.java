...
public class Main {
    public static void main(String[] args) {
        ...
        read.close();
        System.out.println();
        CustomerData.processSales(salesInput);
        for (Map.Entry<String, Map<String, Integer>> entry : CustomerData.getCustomerData().entrySet()) {
        ...
        int invalidInputCount = CustomerData.getInvalidInputCount();
